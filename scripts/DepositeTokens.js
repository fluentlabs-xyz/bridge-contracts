...
async function main() {
    ...
    let l1Token = await Token.connect(signer).attach("0xD61e2a971EEC09cCdDc0c89217dd6D2e49017685")
    ...
    let l1Gateway = await ERC20GatewayContract.connect(signer).attach(l1GatewayAddress)
