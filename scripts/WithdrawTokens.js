...
async function main() {
  ...
  console.log("Token: ", l2Token.address, await l2Token.name(), await l2Token.balanceOf(await signer.getAddress()))
  ...
  let l2Gateway = await ERC20GatewayContract.connect(signer).attach(l2GatewayAddress)
